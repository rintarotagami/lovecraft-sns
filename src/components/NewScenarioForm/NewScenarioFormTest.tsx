...
export function NewScenarioFormTest() {
    const form = useForm<z.infer<typeof uploadScenarioSchema>>({
    ...
    return (
        <Form {...form}>
            <form action={formAction} className="mt-10 mx-auto w-full max-w-7xl bg-gradient-to-br from-amber-50 to-amber-100 p-8 rounded-2xl shadow-2xl">
                    ...
                    <div className="w-full md:w-2/3">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="col-span-2">
                                        <FormLabel htmlFor="isGMless" className="block text-lg font-semibold text-amber-900 mb-2">
                                            GMの有無
                                        </FormLabel>
                                        <FormControl>
